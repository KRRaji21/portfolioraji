...
function fruit(){
	...
	document.getElementById("categoryname").innerHTML=" Guess Fruit Name"
	hangman();
...
function animal(){
	...
	document.getElementById("intropage").style.display="none";
	document.getElementById("singlepage").style.display="none";
	document.getElementById("categoryname").innerHTML=" Guess Animal Name"
	hangman();
}
...
function guessletter()
{
	...
	if (mistake <= 0)
	{
		...
		document.getElementById('hangImgWin').src = "hang11.png";
	...
	if(numRight==wordlength)
	{
		...
		document.getElementById('hangImgWin').src = "hang12.jpg";
		win();
	}
}
